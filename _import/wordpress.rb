...
FROM wp_gtlwka_posts p
LEFT JOIN wp_gtlwka_term_relationships tr
ON tr.object_id = p.ID
LEFT JOIN wp_gtlwka_term_taxonomy tt
ON tr.term_taxonomy_id = tt.term_taxonomy_id
LEFT JOIN wp_gtlwka_terms t
...
SQL
      ...
      db[query].each do |post|
        ...
        content.gsub!(%r(http://hcg.drtoast.com/wp-content/uploads/), '/uploads/')
...
Jekyll::WordPress.process("hcgwp", "root", "", "127.0.0.1")
